...
const Cart = () => {
  ...
  const onApprove = (data, actions) => {
    return actions.order.capture().then(function (details) {
      ...
      // Check if currentUser is not null or undefined before accessing its properties
          ...
          <Summary>
            ...
            {open ? (
              <PayPalScriptProvider
                options={{
                  clientId:
                    "AVFkEKVtRecqPPzwSZnCkf5N9GIBI5gd-N3vMPUfk-TQzgmkF8mA6BzvRciT6TV-G65WuBzbTbbpnBUH",
                  components: "buttons",
                  currency: "USD",
